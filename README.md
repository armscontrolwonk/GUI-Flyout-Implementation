...
| `trajectory.py` glide modes | — | HGV pull-up / glide: Tracy/Acton equilibrium glide, skip-glide, skip→equilibrium, and damped-phugoid glide. See `DAMPED_GLIDE.md` (implementation) and `DAMPED_GLIDE_MEMO.md` (approach, citations, Acton/Tracy comparison) |
